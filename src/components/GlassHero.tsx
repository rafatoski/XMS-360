                ...
                <div className="max-w-7xl">
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-black/60 backdrop-blur-md border border-blue-400/40 text-white/90 text-xs font-mono tracking-widest uppercase mb-6 hover:border-blue-400/70 hover:bg-black/70 transition-all cursor-default shadow-[0_0_16px_rgba(96,165,250,0.12)]"
                        >
                        ...
                        <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold font-display tracking-tight leading-[1.1] mb-6">
                            <span className="bg-gradient-to-r from-blue-400 via-blue-600 to-blue-400 bg-clip-text text-transparent bg-[length:200%_auto] animate-gradient [filter:drop-shadow(0_1px_6px_rgba(0,0,0,0.55))_drop-shadow(0_0_20px_rgba(96,165,250,0.3))]">
